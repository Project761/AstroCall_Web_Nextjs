...
const MaritalLife = () => {
    ...
    const [maritalLifeData, setMaritalLifeData] = useState(undefined);

    useEffect(() => {
        getMaritalLifeData();
    }, []);

    const getMaritalLifeData = async () => {
        const payload = {
            IsActive: "1",
            Category: "Marital Life",
        };
        ...
        try {
            ...
            if (res) {
                ...
                setMaritalLifeData(filteredData);
            } else {
                setMaritalLifeData([]);
            }
        } catch (error) {
    ...
    return (
        <>
            <SEO
                ...
                description="Get expert astrology predictions for your marital life. Consult top astrologers on AstroCall Live for marriage compatibility, delays, and harmony in relationships."
            />
            <div className="bg-[#F973160D]">
                ...
                >
                    <div className="mt-1 w-full">
                        {maritalLifeData === undefined ? (
                            <div className="flex justify-center">
                                <OrbitProgress color="#6b716b" size="medium" />
                            </div>
                        ) : maritalLifeData.length === 0 ? (
                            ...
                            maritalLifeData.map((item, index) => (
