  ...
  return (<>
        ...
        },
        {
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "item": "https://astrocall.live/talk_to_astrologer"
            }
          ]
        },
        {
    ...
    <div className="bg-[#F973160D]">
      <div className="main-container  text-left py-5 ">
        <div className="bg-orange-500 rounded-md w-full text-white text-center py-2 sm:py-2 md:py-4 px-4 mt-18">
          <div className="flex flex-col items-center justify-center text-center">
            <h1 className="text-xl sm:text-xl md:text-3xl font-semibold leading-snug">
              Talk to Our Expert Astrologers
            </h1>
            <h2 className="text-lg sm:text-xl md:text-2xl font-semibold mt-2 sm:mt-3 leading-snug">
              How to Consult Our Expert Astrologers
            </h2>

            <p className="mt-3 sm:mt-4 max-w-2xl text-sm sm:text-base md:text-lg leading-relaxed px-2">
              Connect instantly with our experienced astrologers for
              personalized guidance on career, relationships, health, and
              more. Get live voice-based consultations with our experts.
            </p>
          ...
          return (<div key={card?.ID || index} className="flex bg-white p-3 sm:p-4 rounded-xl shadow-md duration-300 gap-3 sm:gap-4 md:gap-5 hover:scale-105 hover:shadow-lg relative sellerCard">
            ...
            <div className="right-side flex-1 min-w-0">
              <div onClick={() => {
                ...
                router.push(`/talk-to-astrologers/${card.DisplayName}`);
