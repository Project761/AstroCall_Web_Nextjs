...
export default function TalkAstrologerProfileClient() {
  ...
  const data = {
    ...
    ReviewCount: astro?.CallOrders ? (astro.CallOrders >= 1000 ? `${(astro.CallOrders / 1000).toFixed(1)}K` : String(astro.CallOrders)) : "6.2K",
    ExperiencedYears: astro?.ExperiencedYears || 12,
    Consultations: astro?.CallOrders ? `${astro.CallOrders}+` : "1280+",
    ...
    <div className="min-h-screen bg-white pt-16 pb-28">
      <div className="main-container px-4 py-4">
        <nav className="mb-4 flex flex-wrap items-center gap-1.5 text-xs text-gray-500">
          ...
          <button type="button" onClick={() => router.push("/talk-to-astrologers")} className="hover:text-[#FF5C00]">Talk to Astrologer</button>
          <FaChevronRight size={8} className="text-gray-300" />
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-3">
          <div className="lg:col-span-2">
            ...
            <div className="mt-8">
              <div className="mb-4 flex items-center justify-between">
                ...
                <button type="button" onClick={() => router.push("/talk-to-astrologers")} className="text-sm font-semibold text-[#FF5C00] hover:underline">View All</button>
              </div>
          ...
          <aside className="space-y-5 lg:sticky lg:top-20 lg:self-start">
            ...
            <div className="rounded-2xl border border-gray-100 bg-white p-5 shadow-sm">
              ...
              <button type="button" onClick={startCall} className="mt-5 w-full rounded-xl py-3 text-sm font-bold text-white hover:opacity-90" style={{ backgroundColor: GREEN }}>
                Call Now
              </button>
            </div>
          </aside>
