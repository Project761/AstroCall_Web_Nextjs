...
import ChatCallPopup from "../components/ChatCallPopup";
  ...
  return (
    <>
      ...
      <div className="bg-[#F973160D] pt-[72px]">
        <PageBanner
          bannerSrc={PAGE_BANNER_IMAGES.LoveCalculator}
          currentPage="Love Calculator"
          title="Love Calculator Online – Check Your Love Compatibility"
          subtitle="Explore relationship compatibility, cosmic influences, and future predictions. Find your compatibility with your partner."
        />

        <div className="main-container px-3 py-4 text-left sm:px-4 sm:py-5">
