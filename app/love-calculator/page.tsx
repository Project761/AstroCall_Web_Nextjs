...
export default function LoveCalculator() {
  ...
  const { isModalOpen, setIsModalOpen, FAQData, GetData_ActivityLog } =
    useMenuContext();
  ...
  useEffect(() => {
    ...
    if (id) {
      GetData_ActivityLog(
        "Love Calculator",
        "Using Love Calculator (Entered Details & Viewed Result)"
      );
    }
  }, []);
  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta
          name="description"
          content="Free love calculator to check compatibility."
        />
      </Head>
        ...
        <div className="max-w-2xl mx-auto bg-white shadow-xl rounded-2xl p-6 mt-10">
          ...
          <div className="flex mb-6 bg-gray-100 p-1 rounded-full">
            <button
              ...
              className={`flex-1 py-2 rounded-full ${tab === "names"
            ...
            <button
              ...
              className={`flex-1 py-2 rounded-full ${tab === "birthdate"
                  ? "bg-orange-500 text-white"
                  : "text-gray-600"
                }`}
            >
