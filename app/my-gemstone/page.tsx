...
import { FaGem, FaSearch, FaShoppingCart, FaStar, FaHeart } from "react-icons/fa";
...
export default function MyGemStone() {
  ...
  return (
    <>
      <SEO 
        title="My GemStone - AstroCall"
        description="View your purchased gemstones and remedies"
      />
      <Header />
          ...
          {filteredGemstones.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredGemstones.map((gemstone) => (
                <div key={gemstone.id} className="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow">
                  <div className="relative">
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center justify-between mb-3">
                      ...
                      {gemstone.isPurchased && (
                        <span className="text-xs text-gray-500">Purchased: {gemstone.purchaseDate}</span>
                      )}
                    </div>
