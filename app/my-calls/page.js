    ...
    return (<>
      ...
      <div className="min-h-screen bg-gray-50 pt-20">
        <div className="max-w-6xl mx-auto px-4 py-8">
          ...
          {/* Call List */}
          {filteredCalls.length === 0 ? (<div className="bg-white rounded-lg shadow-sm p-12 text-center">
              ...
              {filteredCalls.map((call) => (<div key={call.id} className="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow">
                  <div className="p-4">
                    <div className="flex items-start gap-4">
                      {/* Astrologer Image */}
                      <div className="h-16 w-16 rounded-full overflow-hidden bg-gray-100">
                        <Image src={call.astrologer.image} alt={call.astrologer.name} width={64} height={64} className="w-full h-full object-cover"/>
                      </div>
                      ...
                      <div className="flex-1">
                        ...
                        {/* Call Notes */}
                        {call.notes && (<div className="bg-gray-50 rounded p-2 mb-3">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          {/* Recording Button */}
                          {call.recording && (<button onClick={() => handlePlayRecording(call.id)} className="flex items-center gap-2 bg-blue-500 text-white px-3 py-1 rounded-full text-xs hover:bg-blue-600 transition-colors">
