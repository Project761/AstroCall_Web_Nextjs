    ...
    <div>
      ...
      <div className="carousel2 flex justify-center mt-8 w-full relative">
        <div className="flex items-center w-full gap-5">
          {/* Left Arrow Button */}
          <button onClick={handlePrevious} className="hidden lg:block cursor-pointer bg-white border border-orange-500 text-orange-500 rounded-full p-2 shadow hover:bg-orange-500 hover:text-white transition" disabled={totalCards <= cardsToShow}>
              ...
              <div className="bg-white rounded-xl shadow-lg overflow-hidden flex flex-col h-full">
                ...
                <div className="p-4 flex flex-col gap-1 items-center">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 mt-4 w-full">
                    {/* Call Now Button */}
                    <button className="w-full sm:w-1/2 flex cursor-pointer items-center justify-center gap-1 py-2 rounded-lg text-white transition-transform transform hover:scale-105 bg-[#F0640E]" onClick={() => {
          ...
          {/* Right Arrow Button */}
          <button onClick={handleNext} className="hidden lg:block bg-white border cursor-pointer border-orange-500 text-orange-500 rounded-full p-2 shadow hover:bg-orange-500 hover:text-white transition" disabled={totalCards <= cardsToShow}>
      ...
      <div className="flex justify-center text-center mt-8">
        <button className="border border-orange-500 cursor-pointer text-orange-500 rounded-md px-6 py-2 font-medium hover:bg-orange-500 hover:text-white transition-all duration-200" onClick={() => router.push("/talk-to-astrologers")}>
