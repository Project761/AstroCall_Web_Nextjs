...
function PaymentMethodBtn({ name, icon, onClick }) {
    const renderIcon = () => {
      if (name === "PhonePe") {
...
const OnlinepujaPlansDetailsClient = () => {
  ...
  const GetsinglaData_Puja = useCallback(async () => {
  ...
  useEffect(() => {
    if (slug) {
      void (async () => { await GetsinglaData_Puja(); })();
    }
  }, [slug, GetsinglaData_Puja]);
...
export default OnlinepujaPlansDetailsClient;
