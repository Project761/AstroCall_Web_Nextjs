        ...
        <div className="carousel2 flex justify-between mt-6 sm:mt-8 w-full">
          <div className="relative flex items-center w-full m-auto">
            <div className="main-container px-3 sm:px-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 my-4 sm:my-5 w-full h-full  ">
                ...
                {isCurrentItemsLoading ? (<div className="col-span-full">
                  ...
                  <div className="text my-2 sm:my-3 p-2 sm:p-3 m-auto text-center">
                    ...
                    <div className="p-2 sm:p-2.5 mt-auto bg-orange-500 w-full flex justify-center items-center py-2 sm:py-2.5 text-white rounded-lg hover:bg-orange-600 duration-300 font-semibold shadow-md hover:shadow-lg">
                  ...
                  <div className="text-gray-400 mb-4">
                    {(selectedCategory !== "all" && selectedCategory) || searchVal ? (<img src="/assets/images/pandit.webp" alt="Pooja" className="w-24 h-24 sm:w-32 sm:h-32 mx-auto object-contain" />) : (<FaSearch className="text-5xl sm:text-6xl mx-auto" />)}
                  </div>
            ...
            <div className="bg-white shadow-lg rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 relative text-gray-700 text-sm sm:text-base md:text-lg italic leading-relaxed">
              ...
              <div className="mt-4 sm:mt-6 text-center">
                ...
                <div className="flex justify-center mt-2 gap-0.5 sm:gap-1">
                  {[...Array(5)].map((_, index) => (<FaStar key={index} size={14} className="sm:w-4 sm:h-4 text-primaryColor fill-primaryColor" />))}
                </div>
              </div>
            </div>
          </div>
