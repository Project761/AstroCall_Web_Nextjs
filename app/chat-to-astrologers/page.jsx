...
export default function ChatToAstrologers() {
  const [astrologers, setAstrologers] = useState([]);
  console.log(astrologers, 'astrologer')
  ...
  const Get_Data_Astrologer = async () => {
    try {
      ...
      // 👇 yaha response ke according adjust karna agar res.data ho
      setAstrologers(res || []);
    } catch (error) {
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center justify-between">
                      <Link
                        href={`/chat-to-astrologers/${encodeURIComponent(astro.DisplayName)}`}
                      >
