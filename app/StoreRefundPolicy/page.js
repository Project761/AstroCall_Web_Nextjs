        ...
        try {
            ...
            if (res) {
                const filtered = res.filter(
                    (data) => data?.Category === "Store Refund Policy"
                );
    ...
    return (
        <>
            <SEO
                ...
                description="Review AstroCall’s store refund policy. Learn when you are eligible for a refund on astrology consultations, reports or services purchased through our platform."
                keywords="AstroCall refund policy, store refund policy, astrology service refunds, return policy, refund eligibility, refund process"
                canonical="https://astrocall.live/store-refund-policy"
                type="website"
            />
