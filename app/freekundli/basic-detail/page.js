...
// import CommonServies from "../../components/ChatCallPopup/CommonServies";
import Horoscope from "@/app/components/Horoscope/page";
import ChatCallPopup from "@/app/components/ChatCallPopup/page";
import { MenuContext } from "@/app/context/MenuContext";
import SEO from "@/app/components/SEO/page";
// import SEO from "../../components/SEO/SEO";


const FreeKundliDetails = () => {
  ...
  return (
    ...
    <>
      ...
      <SEO
        ...
        description="Generate your free kundli online on AstroCall. Get an instant Vedic Janam Kundli based on your date, time and place of birth with basic life insights."
        canonical="https://astrocall.live/freekundli"
        type="website"
        schema={
          {
      ...
      <>
        <div className="bg-orange-50 ">
          ...
          <div>
                ...
                <div className="flex gap-4 sm:gap-5 md:gap-6 lg:gap-8 min-w-max">
                  {["Basic", "Kundli", "Charts", "Sade Sati", "Mangal Dosha", "Kalsarpa Doshas"].map(
                    (tab) => (
                      <button
                        key={tab}
                        className={`px-4 sm:px-6 md:px-8 lg:px-10 py-3 sm:py-3.5 md:py-4 text-sm sm:text-base md:text-lg lg:text-xl font-[700] ${activeTab === tab ? "border-b-[3px] border-yellow-500 text-yellow-500" : "text-gray-600 hover:text-yellow-800"} whitespace-nowrap transition-all duration-200 flex-shrink-0`}
                  ...
                  <div>
                    ...
                    <div className='flex flex-col sm:flex-row gap-4 sm:gap-6 md:gap-10 m-4 sm:m-6 md:m-10 flex-wrap' style={{ justifyContent: 'center', alignItems: 'center', textAlign: 'center' }}>
                      <div className="w-full sm:w-auto">
                        ...
                        <div className="overflow-x-auto">
                          {
                            D1ChartKundli?.length > 0 ? <div className="w-full" style={{ maxWidth: '100%', overflow: 'auto' }} dangerouslySetInnerHTML={{ __html: D1ChartKundli }} /> : <div className="p-4"><OrbitProgress color="#6b716b" size="medium" style={{ alignItems: 'center' }} text="" textColor="" /></div>
                          }
                        </div>
                      </div>
                      ...
                      <div className="w-full sm:w-auto">
                        ...
                        <div className="overflow-x-auto">
                          {
                            D9Chartkundli?.length > 0 ? <div className="w-full" style={{ maxWidth: '100%', overflow: 'auto' }} dangerouslySetInnerHTML={{ __html: D9Chartkundli }} /> : <div className="p-4"><OrbitProgress color="#6b716b" size="medium" style={{ alignItems: 'center' }} text="" textColor="" /></div>
                          }
                        </div>
                      </div>
                    ...
                    <div className="mb-4 sm:mb-6 flex items-center justify-center gap-2 sm:gap-4 md:gap-6 flex-wrap px-2">
                      {steps.map((step, i) => (
                        ...
                        >
                          <span
                            className={`w-6 h-6 sm:w-7 sm:h-7 flex items-center justify-center rounded-full border-2 text-xs sm:text-sm ${currentLevel === step.key
                    ...
                    {currentLevel !== "maha_dasha" && (
                      <div className="flex justify-center mt-4 sm:mt-6">
                        <button
                          onClick={handleBack}
                          className="w-full sm:w-auto sm:min-w-[200px] md:min-w-[320px] py-2.5 sm:py-3 bg-orange-500 text-white font-semibold rounded-full shadow-md hover:bg-orange-600 transition duration-300 text-sm sm:text-base"
                        >
                          ⬅ Back
                        </button>
                      </div>
            ...
            {/* <div className="main-container rounded-2xl bg-primaryColor ">
                            <div className="text-center border-1 p-4 rounded-xl">
                                <h3>Connect with an Astrologer on Call or Chat for more personalised detailed predictions.</h3>
                                <br />
                                <div className="flex flex-col md:flex-row items-center justify-center gap-4">
                                    <div className="bg-backgroundColor chat-button px-1 lg:px-9 py-5 rounded-xl hover:bg-black hover:text-white border-2 border-orange-500 duration-300 font-semibold">
                                        <button className="flex items-center gap-1 lg:gap-3 text-xs lg:text-md" onClick={handleclickTalk}>
                                    ...
                                    <div className="bg-backgroundColor chat-button px-1 lg:px-9 py-5 rounded-xl hover:bg-black hover:text-white border-2 border-orange-500 duration-300 font-semibold">
                                        <button className="flex items-center gap-1 lg:gap-3 text-xs lg:text-md" onClick={handleclickChat}>
