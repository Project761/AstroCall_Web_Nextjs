...
import { FaHandsHelping, FaPhone, FaEnvelope, FaHeadset, FaQuestionCircle, FaBook, FaFileAlt, FaComments, FaTicketAlt } from "react-icons/fa";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
                ...
                <form onSubmit={handleSubmitTicket} className="space-y-4">
                  ...
                  <div>
                    ...
                    <input type="text" value={subject} onChange={(e) => setSubject(e.target.value)} placeholder="Brief description of your issue" className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500" required/>
                  </div>
                  ...
                  <div>
                    ...
                    <textarea value={message} onChange={(e) => setMessage(e.target.value)} placeholder="Please describe your issue in detail" rows={5} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500" required/>
                  </div>

                  <button type="submit" disabled={isSubmitting} className="w-full bg-orange-500 text-white py-3 rounded-lg hover:bg-orange-600 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed">
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                {tickets.length === 0 ? (<div className="text-center py-8">
                    <FaQuestionCircle className="text-gray-300 text-4xl mx-auto mb-3"/>
                    <p className="text-gray-600">No support tickets yet</p>
                  </div>) : (<div className="space-y-3">
                    {tickets.map((ticket) => (<div key={ticket.id} className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors">
                        <div className="flex items-start justify-between mb-2">
                          ...
                          <span className={`px-2 py-1 rounded-full text-xs font-medium ${ticket.status === "open" ? "bg-yellow-100 text-yellow-600" :
                    ticket.status === "resolved" ? "bg-green-100 text-green-600" :
                        ...
                        <div className="flex items-center justify-between text-xs text-gray-500">
                          ...
                          <span className={`px-2 py-1 rounded ${ticket.priority === "high" ? "bg-red-100 text-red-600" :
