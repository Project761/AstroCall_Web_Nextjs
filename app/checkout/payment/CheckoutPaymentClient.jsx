...
const LoadingIndicator = ({ color = "#FF5C00", size = "medium" }) => {
    ...
    if (!gemstonedata) {
        return (<div className="flex justify-center items-center py-20">
          <div className="text-center">
            ...
            <button onClick={() => router.push("/gemstone")} className="mt-4 rounded-lg bg-[#FF5C00] px-6 py-2 text-white transition hover:bg-[#E85500]">
              Back to Gemstones
            </button>
          </div>
        </div>);
      ...
      <div className="relative min-h-screen pt-[72px] py-8 sm:py-12" style={{ backgroundColor: "#FFF9F1" }}>
        ...
        <div>
          <div className="heading main-container px-3 sm:px-4 py-6 sm:py-8 md:py-10">
            ...
            <div className="w-[100px] sm:w-[120px] md:w-[150px] h-[2px] sm:h-[3px] m-auto rounded-full bg-[#FF5C00] my-2 sm:my-3"></div>
          </div>
          ...
          <div className="main-container px-3 sm:px-4 md:px-6 lg:px-20">
            <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 md:gap-8 py-4 sm:py-6 md:py-8">
              <div className="lg:w-1/2 w-full bg-orange-50 p-4 sm:p-6 md:p-8 lg:p-10 rounded-xl sm:rounded-2xl shadow-md border">
                <h2 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4 text-[#FF5C00]">Payment Summary</h2>
              ...
              <div className="lg:w-1/2 w-full bg-white p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-md border">
                <h2 className="text-lg sm:text-xl font-bold mb-4 sm:mb-6 text-[#FF5C00] text-center">Choose Payment Method</h2>
