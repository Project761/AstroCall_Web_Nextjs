...
import { FaUserFriends, FaSearch, FaFilter, FaUser, FaStar, FaPhone, FaComment, FaHeart } from "react-icons/fa";
...
export default function MyFollowing() {
  ...
  const filteredFollowing = following.filter(astrologer => 
  ...
  return (
    <>
      <SEO 
        ...
        description="Manage astrologers you are following"
      />
      <Header />
        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
          ...
          <div className="bg-white rounded-lg shadow-sm p-4 mb-6">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search followed astrologers..."
                value={searchTerm}
          ...
          {filteredFollowing.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredFollowing.map((astrologer) => (
                <div key={astrologer.id} className="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex gap-2">
                      <button
                        onClick={() => router.push(`/talk-to-astrologers/${astrologer.id}`)}
                      ...
                      <button
                        onClick={() => router.push(`/chat-to-astrologers/${astrologer.id}`)}
                    ...
                    <button
                      onClick={() => handleUnfollow(astrologer.id)}
                      className="w-full mt-2 border border-red-300 text-red-500 py-2 rounded-lg hover:bg-red-50 transition-colors flex items-center justify-center gap-2 text-sm"
                    >
